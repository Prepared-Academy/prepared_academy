            ...
            SizedBox(
              ...
              child: Consumer<HomeProvider>(builder: (context, provider, __) {
                return ListView.builder(
                  ...
                  itemCount: provider.getNewsFeedData.suggestedVideo!.length,
                          ...
                          child: InkWell(
                            ...
                            child: Center(
                              child: ListTile(
                                leading: Container(
                                  ...
                                  decoration: BoxDecoration(
                                      ...
                                      image: DecorationImage(
                                        image: NetworkImage(
                                          "${AppConstants.BASE_URL}/upload/ChapterPic/${provider.getNewsFeedData.suggestedVideo![index].objImage}",
                                        ),
                                      )),
                                ),
                                title: Text(
                                  provider.getNewsFeedData
                                      .suggestedVideo![index].name
                                      .toString(),
                                ...
                                subtitle: Text(
                                  provider.getNewsFeedData
                                      .suggestedVideo![index].description
                                      .toString(),
                                  maxLines: 2,
                                  style: const TextStyle(
                                    fontSize: 14,
          ...
          children: [
            ...
            Consumer<HomeProvider>(builder: (context, provider, __) {
              return LiveList(
                ...
                shrinkWrap: true,
                itemCount: provider.getNewsFeedData.posts!.length,
                        ...
                        children: [
                          GestureDetector(
                            onTap: () {
                              OneContext().push(
                                MaterialPageRoute(
                                  builder: (context) => CachedImage(
                                    imageUrl:
                                        "${AppConstants.BASE_URL}/upload/Post/${provider.getNewsFeedData.posts![index].attachment1}",
                                  ),
                                ),
                              );
                            },
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                  ...
                                  children: [
                                    CircleAvatar(
                                      ...
                                      backgroundImage: NetworkImage(
                                        "${AppConstants.BASE_URL}/upload/userProfile/${provider.getNewsFeedData.posts![index].profileImage}",
                                      ),
                                    ),
                                    const SizedBox(width: 10),
                                    // Text(
                                    //   provider
                                    //       .getNewsFeedData.posts![index].title
                                    //       .toString(),
                                    //   style: const TextStyle(
                                    //     fontSize: 16,
                                    ...
                                    // ),
                                    Text(
                                      provider.getNewsFeedData.posts![index]
                                          .userName!,
                                      style: const TextStyle(
                                        fontSize: 16,
                                        fontWeight: FontWeight.w500,
                                ...
                                Text(
                                  provider.getNewsFeedData.posts![index].title!,
                                  style: const TextStyle(
                                    fontSize: 15,
                                    fontWeight: FontWeight.bold,
                                  ),
                                ...
                                Text(
                                  provider
                                      .getNewsFeedData.posts![index].subtitle!,
                                  style: const TextStyle(
                                    fontSize: 12,
                                    fontWeight: FontWeight.w500,
                                  ),
