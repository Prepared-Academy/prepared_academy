    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      ...
      if (arguments.isNotEmpty) {
        Future.microtask(() => context
            ...
            .getChatperModuleQuiz(arguments["objectiveId"]));
        setState(() => objectiveId = arguments["objectiveId"]);
      }
    });
  }
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child:
          ...
          return provider.quizActivityList.isEmpty
              ? const SizedBox()
              : Column(
                  children: [
                    Row(
                                                            ...
                                                            borderRadius:
                                                                BorderRadius
                                                                    .circular(
                                                                        10.0)),
                                                    onTap: () {
                                                      provider.addQuizAnswer(
                                                        objectiveId,
                                                        index,
                                                        quiz.quizmapId!,
                                                        quizOptions.questionId!,
                                                        quizOptions.optionsId!,
                                                      );
                                                    },
                                                    selected: isSelected,
                                                    selectedTileColor:
